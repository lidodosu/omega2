...
function Chart({amountPoint, valMinX, valMaxX, valMinY, valMaxY, checkedGrid, checkedLabelAxis}) {

    drawChart();
    
    console.log("!!!!!!!!", amountPoint, valMinX, valMaxX, valMinY, valMaxY, checkedGrid, checkedLabelAxis);
    return (
            <svg className="svg" 
                id="svg" 
